...
- [x] **MAPW-01**: Interactive map widget with pinch-zoom and pan
- [x] **MAPW-02**: Tap territory to select (attack source/target, fortify source/target)
- [x] **MAPW-03**: Territories colored by owning player with army counts displayed
- [x] **MAPW-04**: Territory highlighting (valid sources, valid targets, selected)
- [x] **MAPW-05**: Hit-test expansion for small territories on phone screens
